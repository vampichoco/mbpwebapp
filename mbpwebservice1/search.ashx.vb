        ...
        If context.Request.QueryString("c") IsNot Nothing Then
            ...
            Dim prodsQuery = From prod In db.prods Where prod.ARTICULO.Contains(term) Or prod.DESCRIP.Contains(term)
                             Select New With {
                                 ...
                                 .PRECIO = prod.PRECIO1 * 1.035,
                                 .PRECIO1 = prod.PRECIO4 * 1.035,
                                 .PRECIO2 = prod.PRECIO5 * 1.035,
                                 .PRECIO3 = prod.PRECIO6 * 1.035,
                                 .C1 = prod.C4,
                                 .C2 = prod.C5,
                                 .C3 = prod.C6,
        ...
        Else
            Dim prodsQuery = From prod In db.prods
                             Select New With {
                                 ...
                                 .DESCRIP = prod.DESCRIP,
                                 .PRECIO = prod.PRECIO1 * 1.035,
                                 .PRECIO1 = prod.PRECIO1 * 1.035,
                                 .PRECIO2 = prod.PRECIO2 * 1.035,
                                 .PRECIO3 = prod.PRECIO6 * 1.035,
                                 .C1 = prod.C4,
                                 .C2 = prod.C5,
                                 .C3 = prod.C6,
